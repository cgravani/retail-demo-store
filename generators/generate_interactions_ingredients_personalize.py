...
IN_PRODUCTS_FILENAME = "src/products/src/products-service/data/ingredients.yaml"
...
out_items_filename = f"{GENERATED_DATA_ROOT}/ingredients.csv"
out_users_filename = f"{GENERATED_DATA_ROOT}/users.csv"
out_interactions_filename = f"{GENERATED_DATA_ROOT}/interactions_ingredients.csv"
